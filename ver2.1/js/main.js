...
var topWrapper = $('.topWrapper'),
    ...
    cssClass = $('.cssClass'),
    jsClass = $('.jsClass'),
    angularLeftClass = $('.angularLeftClass'),
...
//STARTS ANIMATION POSITION
htmlClass.transition({ y: -10, opacity: 0 }, 10, 'easeOutQuad');
cssClass.transition({ y: 10, opacity: 0 }, 10, 'easeOutQuad');
jsClass.transition({ y: -10, opacity: 0 }, 10, 'easeOutQuad');
angularLeftClass.transition({ y: -10, opacity: 0 }, 10, 'easeOutQuad');
angularRightClass.transition({ y: 10, opacity: 0 }, 10, 'easeOutQuad');
rubyClass.transition({ x: 10, opacity: 0 }, 10, 'easeOutQuad');

//ANIMATION TOP
topWrapper.hover(
  function() {
    htmlClass.transition({ y: 0, opacity: 1 }, 1000, 'easeOutQuad');
    ...
    htmlClass.transition({ y: -10, opacity: 0 }, 750, 'easeOutQuad');
